...
// Init value to get messageCode
let messageCode = '';

// Your code goes here
hiddenMessage.forEach(code => {
  // Condition to get value different to 'X'
  code !== "X" ? messageCode += code : null
});

console.log('Exercice 1 decoded : ', messageCode);
messageCode = '';
...
// Your code goes here
// Convert string to array and remove X
